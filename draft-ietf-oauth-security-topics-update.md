...
- the OAuth provider specifies an AS not by individual AS endpoints but instead by an abstract issuer identifier (as defined in {{Section 4.4 of RFC9700}}) representing the endpoints, and
