...
4. Due to implicit or prior approvals, the user might not be prompted for re-consent. H-AS issues a code and sends it (via the browser) back with the `state` to the client.
